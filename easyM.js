...
function output(ranIn, num) 
{
  ...
  document.getElementById("easyQues" + num).innerHTML = ques1;
  document.getElementById("easyAns1" + num).innerHTML = radioButton[rand1];
  document.getElementById("easyAns2" + num).innerHTML = radioButton[rand2];
  document.getElementById("easyAns3" + num).innerHTML = radioButton[rand3];
...
function checkButton(radioButton, num) 
{
    ...
    for(let i = 1; i < 4; i++)
    {
      if(document.getElementById("easyAns" + i + num).innerHTML == radioButton[0])
        correct = i;
    }
