...
function output(ranIn, num) 
{
  ...
  document.getElementById("hardQues" + num).innerHTML = ques1;
  document.getElementById("hardAns1" + num).innerHTML = radioButton[rand1];
  document.getElementById("hardAns2" + num).innerHTML = radioButton[rand2];
  document.getElementById("hardAns3" + num).innerHTML = radioButton[rand3];
...
function checkButton(radioButton, num) 
{
    ...
    for(let i = 1; i < 4; i++)
    {
      if(document.getElementById("hardAns" + i + num).innerHTML == radioButton[0])
        correct = i;
    }
